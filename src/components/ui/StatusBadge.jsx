export default function StatusBadge({ status }) {
  const styles = {
    ...
    verified: "border border-emerald-400/30 bg-emerald-500/10 text-emerald-200",
    ...
    minor_pending: "border border-purple-400/30 bg-purple-500/10 text-purple-200",
    ...
    none: "border border-white/10 bg-white/5 text-white/55",
  };
